  <?php $__env->startSection('content'); ?>
    ...
    <ol class='breadcrumb'>
        ...
        <li><a href='/Buyers/<?php echo e($demands->id); ?>'><?php echo e($demands->name); ?></a></li>
    ...
    <!-- crop_name Form Input -->
        <div class="form-group<?php echo e($errors->has('crop_name') ? ' has-error' : ''); ?>">
            ...
            <input type="text" class="form-control" name="crop_name" value="<?php echo e($demands->crop_name); ?>">
